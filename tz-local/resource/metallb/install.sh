...
source /root/.bashrc
cd /topzone/tz-local/resource/metallb
...
k delete -f /topzone/tz-local/resource/metallb/layer2-config.yaml
k apply -f /topzone/tz-local/resource/metallb/layer2-config.yaml
