...
http://nexus.default.${k8s_project}.${k8s_domain}/#admin/security/sslcertificates
  ...
  docker.default.topzone-k8s.new-nation.church


DOCKER_ELB=nexus.topzone-k8s.new-nation.church:5433
...
docker login -u admin https://docker.default.topzone-k8s.new-nation.church --password-stdin admin123


https://nexus.topzone-k8s.new-nation.church/#admin/security/privileges

docker login nexus.topzone-k8s.new-nation.church:5433

Get "https://xxx/v2/": dial tcp: lookup xxx on 127.0.0.53:53: no such host

docker.topzone-k8s.new-nation.church