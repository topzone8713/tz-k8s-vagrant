...
if [[ ! -d 'projects/tz-py-crawler' ]]; then
  mkdir projects
  cd projects
  git clone https://github.com/topzone8713/tz-py-crawler.git
fi
...
docker image ls
docker tag tz-py-crawler:latest topzone8713/tz-py-crawler:latest
docker push topzone8713/tz-py-crawler:latest
...
#docker tag tz-py-crawler 192.168.86.100:5000/topzone8713/tz-py-crawler
#docker push 192.168.86.100:5000/topzone8713/tz-py-crawler
